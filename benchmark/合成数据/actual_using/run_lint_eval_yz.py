...
# RULES_PATH = os.path.join(WORKSPACE_ROOT, "actual_using/DocLinter方案_origin/prompt/misspelling_yz.md")
# RULES_PATH = os.path.join(WORKSPACE_ROOT, "actual_using/DocLinter方案_origin/prompt/chinese_misspelling_yz.md")
RULES_PATH = os.path.join(WORKSPACE_ROOT, "actual_using/DocLinter方案_origin/prompt/chinese_misspelling.md")
INPUT_DIR = os.path.join(WORKSPACE_ROOT, "actual_using/error_doc")
ANNOTATIONS_PATH = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/annotation.json")
PREDICTIONS_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/predictions_ch_en_ori.json")
REPORT_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/eval_report_ch_en_ori.json")
# PREDICTIONS_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/predictions_ch_en.json")
# REPORT_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/eval_report_ch_en.json")
# PREDICTIONS_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/predictions_chinese_misspelling.json")
# REPORT_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/eval_report_chinese_misspelling.json")
# PREDICTIONS_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/predictions_chinese_misspelling_yz.json")
# REPORT_OUT = os.path.join(WORKSPACE_ROOT, "actual_using/spelling_error/eval_report_chinese_misspelling_yz.json")
# WORKSPACE_ROOT = "/root/code/docs_llm"
# RULES_PATH = os.path.join(WORKSPACE_ROOT, "actual_using/DocLinter方案_origin/prompt/colloquial_expression.md")
# INPUT_DIR = os.path.join(WORKSPACE_ROOT, "results_error/zh-cn-bad")
# ANNOTATIONS_PATH = os.path.join(WORKSPACE_ROOT, "results_error/annotations.json")
# PREDICTIONS_OUT = os.path.join(WORKSPACE_ROOT, "results_error/predictions_colloquial_expression.json")
# REPORT_OUT = os.path.join(WORKSPACE_ROOT, "results_error/eval_report_colloquial_expression.json")
...
def load_ground_truth(path: str) -> Dict[str, List[int]]:
    ...
    for obj in arr:
        if obj.get("rule") != "chinese_misspelling":
            continue
...
def main():
    ...
    parser.add_argument("--rules_path", default=RULES_PATH, help="Path to chinese_misspelling.md prompt rules")
