...
def build_vector_database(docs_path: str = "results/complete_knowledge_base.json"):
    """
...
if __name__ == "__main__":
    ...
    docs_path = sys.argv[1] if len(sys.argv) > 1 else "results/complete_knowledge_base.json"
