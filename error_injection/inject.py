...
def main():
	...
	parser.add_argument("--out_dir", default="/root/code/docs_llm/results_error/zh-cn-bad")
	parser.add_argument("--annotation_file", default="/root/code/docs_llm/results_error/annotations.json")
